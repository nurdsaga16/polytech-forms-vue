...
const openShareModal = (survey) => {
  surveyUrl.value = `${window.location.origin}/survey/${survey.public_id}` // Используем public_id
    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div v-if="authStore.emailVerified">
        ...
        <div v-else class="grid gap-4">
          <div
            v-if="surveyStore.surveys.length === 0"
            ...
            <div class="card-body">
              <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div class="flex flex-col flex-wrap gap-2">
                  <RouterLink :to="'/survey/answer/' + survey.public_id" class="btn btn-outline">
